...
class LetterCell: UICollectionViewCell {
  ...
  func set(style: LetterCellStyle) {
    ...
    // ...
      ...
      case .incorrect:
          let wrongColor = UIColor(red: 0.23, green: 0.23, blue: 0.24, alpha: 1.0)
                      contentView.backgroundColor = wrongColor
                      layer.borderColor = wrongColor.cgColor
      case .correctLetterOnly:
                  // correctLetterOnly: mustard color
                  let presentColor = UIColor(red: 0.69, green: 0.63, blue: 0.30, alpha: 1.0)
                  contentView.backgroundColor = presentColor
                  layer.borderColor = presentColor.cgColor

      case .correctLetterAndPosition:
                  // correctLetterAndPosition: green background
                let exactColor = UIColor(red: 0.38, green: 0.55, blue: 0.33, alpha: 1.0)
                  contentView.backgroundColor = exactColor
                  layer.borderColor = exactColor.cgColor
                }
      }
    // END YOUR CODE HERE
}
